...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/spongehunters/map_data_files/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Dr")
...
(map1<-map1+
    ggtitle("Dosilia radiospiculata")+
